...
layout = [
    ...
    [sg.Push(), sg.Text('Articulated Manipulator MEXE Calculator', font = ("Eras Demi ITC", 16)), sg.Push()],
    ...
    [sg.Push(), sg.Button('Click this before Solving Forward Kinematics', font = ("Eras Demi ITC", 13), size=(40,0), button_color=('white', 'red')), sg.Push(),
     sg.Text('OR', font = ('Eras Demi ITC', 8)), sg.Push(),
     sg.Button('Solve Inverse Kinematics', font = ("Eras Demi ITC", 13), size=(40,0), button_color=('white', 'red')), sg.Push()],
    
    [sg.Text('Fill out the following fields:', font = ("Eras Demi ITC", 12))],
    
    [sg.Text('a1 = ', font = ('Eras Demi ITC', 10)),sg.InputText('0', key='a1', size=(30,20)),
     sg.Text('T1 = ', font = ('Eras Demi ITC', 10)),sg.InputText('0', key='T1', size=(30,20)),
    ...
    [sg.Text('a2 = ', font = ('Eras Demi ITC', 10)),sg.InputText('0', key='a2', size=(30,20)),
     sg.Text('T2 = ', font = ('Eras Demi ITC', 10)),sg.InputText('0', key='T2', size=(30,20)),
    ...
    [sg.Text('a3 = ', font = ('Eras Demi ITC', 10)),sg.InputText('0', key='a3', size=(30,20)),
     sg.Text('T3 = ', font = ('Eras Demi ITC', 10)),sg.InputText('0', key='T3', size=(30,20)), sg.Push(),
     sg.Push(), sg.Button('Path and Trajectory Planning', font = ('Eras Demi ITC', 12), size =(62,0), button_color=('blue', 'pink'))],
    
    [sg.Button('Solve Forward Kinematics', disabled=True, tooltip = 'Click the top button first!', font = ('Eras Demi ITC', 12), size=(53,0), button_color=('lightgreen', 'gray'))],
...
def Inverse_Kinematics_window():
    ...
    EXCEL_FILE = '3-DOF Articulated Design Data_IK.xlsx'
    IK_df = pd.read_excel(EXCEL_FILE)
    
    IK_layout = [
        [sg.Push(),sg.Text('Inverse Kinematics', font = ("Eras Demi ITC", 11)), sg.Push()],
         
        [sg.Text('Fill out the following fields:', font = ("Eras Demi ITC", 9))],
        
        [sg.Text('a1 = ', font = ('Eras Demi ITC', 8)),sg.InputText('0', key='a1', size=(8,10)),
         sg.Text('mm', font = ('Eras Demi ITC', 8)),
             sg.Text('X = ', font = ('Eras Demi ITC', 8)),sg.InputText('0', key='X', size =(8,10)),
             sg.Text('mm', font = ('Eras Demi ITC', 8))],
         
        [sg.Text('a2 = ', font = ('Eras Demi ITC', 8)),sg.InputText('0', key='a2', size=(8,10)),
         sg.Text('mm', font = ('Eras Demi ITC', 8)),
            sg.Text('Y = ', font = ('Eras Demi ITC', 8)),sg.InputText('0', key='Y', size =(8,10)),
            sg.Text('mm', font = ('Eras Demi ITC', 8))],
    
        [sg.Text('a3 = ', font = ('Eras Demi ITC', 8)),sg.InputText('0', key='a3', size=(8,10)),
         sg.Text('mm', font = ('Eras Demi ITC', 8)),
             sg.Text('Z = ', font = ('Eras Demi ITC', 8)),sg.InputText('0', key='Z', size =(8,10)),
             sg.Text('mm', font = ('Eras Demi ITC', 8))],
        
        [sg.Button('Solve Inverse Kinematics', font = ('Eras Demi ITC', 12), size=(47,0), button_color=('white', 'red'))],
        
        [sg.Frame('Position Vector: ',[[
            sg.Text('Th1 = ', font = ('Eras Demi ITC', 8)),sg.InputText(key='IK_Th1', size =(10,1)),
            sg.Text('degrees', font = ('Eras Demi ITC', 8)),
            
            sg.Text('Th2 = ', font = ('Eras Demi ITC', 8)),sg.InputText(key='IK_Th2', size =(10,1)),
            sg.Text('degrees', font = ('Eras Demi ITC', 8)),
            
            sg.Text('Th3 = ', font = ('Eras Demi ITC', 8)),sg.InputText(key='IK_Th3', size =(10,1)),
            sg.Text('degrees', font = ('Eras Demi ITC', 8))]])],
        
        [sg.Submit(font = ('Eras Demi ITC', 8), button_color=('yellow', 'purple')), sg.Exit(font = ('Eras Demi ITC', 8), button_color=('yellow', 'purple'))]
        ]
